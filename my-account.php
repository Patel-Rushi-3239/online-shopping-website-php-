...
<div class="form-group">
             <div class="form-group">
					    <label class="info-title" for="Enter your E-mail">E-mail id<span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="email" name="maile">
					  </div>
					  <button type="submit" name="varify" class="btn-upper btn btn-primary checkout-page-button">varify </button>
<br>
